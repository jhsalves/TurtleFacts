...
.controller('ListCtrl', ['$scope','TurtleService',function($scope,TurtleService) {
    $scope.turtleData = TurtleService.getTurtles();
    $scope.activeTurtle = {};
    $scope.currentTurtle = {};
    $scope.search = "";
...
var turtleData = [
  {
      type: "Green Turtle",
      image_url: "https://www.bioexpedition.com/wp-content/uploads/2012/06/Laying_About_600.jpg",
