# TurtleFacts
An AngularJS api that list/details turtle facts and provides an quiz about the turtles

## `angular-seed` — the seed for AngularJS apps

This project is based on application skeleton for a typical [AngularJS][angularjs] web app. You can use it
